...
import {getDateHoursMinutes, getEventDuration} from '../../utils/event.js';
  ...
  return `<li class="trip-events__item">
    <div class="event">
      ...
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="2019-03-18T10:30">${getDateHoursMinutes(startDate)}</time>
          —
          <time class="event__end-time" datetime="2019-03-18T11:00">${getDateHoursMinutes(endDate)}</time>
        </p>
...
export default class Events extends AbstractView {
  ...
  _editClickHandler(evt) {
    evt.preventDefault();
    this._callback.editClick(); // Вызываем callback
  }
